    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', django_jalali.db.models.jDateTimeField(auto_now_add=True, verbose_name='تاریخ عضویت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('manager', 'مدیر'), ('warehouse', 'انباردار'), ('accountant', 'حسابدار'), ('sales', 'فروشنده'), ('content', 'تولید محتوا')], max_length=20, verbose_name='نقش')),
                ('is_active_staff', models.BooleanField(default=True, verbose_name='فعال')),
